...
The project uses Node.js and the Create-React-App starter. If you do not have Node >= 6.8.x installed to use React Hooks, you can download it here: [Node.js](https://nodejs.org/en/)
